...
@click.option(
    ...
    show_default = True,
    type = click.STRING,
    help = 'File path to force field containing protein library charges.',
)
@click.option(
    '-o',
    '--output_ff',
...
def main(input_ff, library_charge_ff, output_ff):

    # Combine initial small molecule force field and protein library charges
    force_field = ForceField(input_ff, library_charge_ff)
